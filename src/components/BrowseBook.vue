...
<template>
  ...
  <main style="margin-top: 10%">
    <div v-for="(book, index) in filteredBooks" :key="index" class="books">
      <!-- Use filteredBooks -->
      <div>
      ...
      <div class="descp">
        ...
        <p style="margin-bottom: 2%; color: white; font-size: 18px">
          <span style="font-weight: bold; text-align: justify; color: white"
            >Description: </span
          >{{ book.description }}
        </p>
        <p style="margin-bottom: 2%; color: white; font-size: 18px">
          <span style="font-weight: bold; color: white">Price:</span> ${{
            book.price
          }}
        </p>
...
.confirmation-popup {
  ...
  background-color: rgba(244, 241, 241, 0.684);
  color: white;
  padding: 20px;
  border-radius: 5px;
  z-index: 1000;
